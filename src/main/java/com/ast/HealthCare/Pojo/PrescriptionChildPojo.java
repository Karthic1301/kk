...
public class PrescriptionChildPojo {
	...
	private List<PatientTestPojo> test;
	
	@Override
	public String toString() {
		return "PrescriptionChildPojo [disease=" + disease + ", comp=" + comp + ", inves=" + inves + ", findings="
				+ findings + ", diag=" + diag + ", pres=" + pres + ", notes=" + notes + ", test=" + test + "]";
	}
	
	
	public List<PatientTestPojo> getTest() {
		return test;
	}


	public void setTest(List<PatientTestPojo> test) {
		this.test = test;
	}
